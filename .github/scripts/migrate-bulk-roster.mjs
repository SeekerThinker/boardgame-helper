...
const unitPath = 'tests/unit/tabletop-bulk-roster.test.js';
fs.writeFileSync(unitPath, `import test from 'node:test';
...
const docsPath = 'TABLE_OS.md';
replaceOnce(docsPath,
`- 玩家同步 / 扩展参与者`,
`- 玩家同步 / 单个或批量扩展参与者`);
replaceOnce(docsPath,
...
console.log('bulk roster migration applied');
