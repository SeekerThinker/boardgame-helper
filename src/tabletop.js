...
import {
  ...
  addScoreSheetField, setScoreSheetFieldKey, removeScoreSheetField, setScoreSheetValue, setScoreRankingMode, scoreCardForParticipant, scoreStandings,
...
function bindEvents() {
  ...
  document.addEventListener('change', event => {
    ...
    if (d.osScoreRanking !== undefined) { setScoreRankingMode(state, element.value); persist(); render(); return; }
